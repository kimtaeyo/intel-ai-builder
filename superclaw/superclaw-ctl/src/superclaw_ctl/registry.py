...
class VllmModelEntry:
    ...
    revision: str = "main"
    local_dir_name: str = ""
    legacy_local_dir_name: str = ""  # Prior on-disk directory name, if it differs from local_dir_name; used by `models migrate-layout`
...
def load_registry(path: Path | None = None) -> VllmRegistry:
    ...
    models = [
        VllmModelEntry(
            ...
            legacy_local_dir_name=m.get("legacy_local_dir_name", ""),
